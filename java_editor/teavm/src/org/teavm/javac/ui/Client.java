 ...
 * TODO: 
 * 1. 简化当前类
 * 2. 增强compiler项目，调用javac的api对编译的类进行分析！！！！
 * 3. 参考现有的javac项目，两个java语言服务器
 * 4. 参考atom的java自动完成，思路不一样(用的javap反编译处理)： https://github.com/keskiju/autocomplete-java
 */
